        ...
        <div className="bg-secondary min-h-[80vh] py-16">
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-border/40">
                    <h1 className="text-3xl font-black text-gray-900 mb-8 text-center">سياسة الخصوصية</h1>
                    ...
                    <div className="space-y-8 text-right font-medium text-gray-600 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-800 mb-4">3. حماية البيانات</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-800 mb-4">5. تواصل معنا</h2>
