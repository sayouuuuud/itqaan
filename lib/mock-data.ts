...
export const NATIONALITIES = [
  ...
  'غامبي', 'جورجي', 'ألماني', 'غاني', 'يوناني', 'غرينادي', 'غواتيمالي', 'غيني', 'غينيا بيساو', 'غياني',
  'هايتي', 'هندوراسي', 'مجري', 'أيسلندي', 'هندي', 'إندونيسي', 'إيراني', 'عراقي', 'أيرلندي', 'إسرائيلي',
  'إيطالي', 'إيفواري', 'جامايكي', 'ياباني', 'أردني', 'كازاخستاني', 'كيني', 'كيريباتي', 'كويتي', 'قرغيزي',
  'لاوسي', 'لاتفي', 'لبناني', 'ليسوتو', 'ليبيري', 'ليبي', 'ليختنشتايني', 'ليتواني', 'لوكسمبورغي', 'مدغشقري',
  'مالاوي', 'ماليزي', 'مالديفي', 'مالي', 'مالطي', 'مارشالي', 'موريتاني', 'موريشيوسي', 'مكسيكي', 'ميكرونيزي',
  'مولدوفي', 'موناكو', 'منغولي', 'مونتينيغري', 'مغربي', 'موزمبيقي', 'ميانماري', 'ناميبي', 'ناوروي', 'نيبالي',
  'هولندي', 'نيوزيلندي', 'نيكاراغوي', 'نيجري', 'نيجيري', 'كوري شمالي', 'مقدوني شمالي', 'نرويجي', 'عماني', 'باكستاني',
  'بالاوي', 'فلسطيني', 'بنمي', 'بابوا غينيا الجديدة', 'باراغواياني', 'بيروفي', 'فلبيني', 'بولندي', 'برتغالي', 'قطري',
  'روماني', 'روسي', 'رواندي', 'سانت كيتس ونيفيس', 'سانت لوسيا', 'سانت فنسنت والغرينادين', 'ساموي', 'سان مارينو', 'ساو تومي وبرينسيب', 'سعودي',
  'سنغالي', 'صربي', 'سيشلي', 'سيراليوني', 'سنغافوري', 'سلوفاكي', 'سلوفيني', 'جزر سليمان', 'صومالي', 'جنوب أفريقي',
  'كوري جنوبي', 'جنوب سوداني', 'إسباني', 'سريلانكي', 'سوداني', 'سورينامي', 'سويدي', 'سويسري', 'سوري', 'طاجيكي',
  'تنزاني', 'تايلاندي', 'تيموري', 'توغولي', 'تونغي', 'ترينيدادي', 'تونسي', 'تركي', 'تركمانستاني', 'توفالوي',
