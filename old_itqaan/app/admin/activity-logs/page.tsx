            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm flex flex-wrap gap-4">
                ...
                <div className="flex flex-wrap gap-3 items-center">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-400">{t.admin.dateTo}</span>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
                ...
                {loading ? (
                    ...
                    <div className="p-20 text-center">
                        ...
                        <p className="text-gray-500 font-medium">{t.admin.noLogsFound}</p>
                    </div>
                ) : (
                                    ...
                                    <tr key={l.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="py-4 px-5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p className="text-sm font-bold text-gray-800">{l.user_name || t.admin.system}</p>
                                                    {l.user_role && (
